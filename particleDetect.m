...
% verbose = false;
    ...
    if boundaryType == "annulus"
        ...
        for frame = 1:nFrames
            ...
            % preProname = [images(frame).name(1:end-10), '.JPG'];
            ...
            % thresim = bsxfun(@times, thresim, cast(wallMask, class(thresim)));
            % 
            % [centers, radii, metrics] = AlecParticleFind(thresim,wallMask,RS,RL,NS,NL);%values found by tweaking 
            %%%%%%%%%%%%%%%%%%%%%%%%%
